...
public class CellularTissues extends Unit {
    public CellularTissues(String type, DefaultFight defaultFight, DefenseDefault defenseDefault, DefaultDisplacement defaultDisplacement, UnitState unitState) {
