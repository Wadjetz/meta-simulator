...
public class Flu extends Unit {
    public Flu(String type, DefaultFight defaultFight, DefenseDefault defenseDefault, DefaultDisplacement defaultDisplacement, UnitState unitState) {
